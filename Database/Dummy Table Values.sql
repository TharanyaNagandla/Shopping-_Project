...
('Venkatraman','2345','venkat@yahoo.com','9876534566','boyapallam','Vishakapatnam','India'),
...
select * from Orders
insert into Orders(User_id,Prod_id,Prod_Price,Prod_Quantity,Retail_id)
values(1,101,5000,1,1000),
(1,103,500,1,1001),
(1,104,890,1,1001),
(1,105,10000,1,1002),
(2,101,5000,1,1000),
...
insert into Cart(User_Id,Prod_Id,Prod_Quantity,Prod_Price)
values(1,101,1,1000),
(1,103,1,500),
(1,104,1,890),
(1,105,1,10000),
...
insert into Cart(User_Id,Prod_Id,Quantity,Prod_Price)
values(5,104,1,890),
(6,105,1,10000)
